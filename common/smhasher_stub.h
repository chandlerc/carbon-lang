...
inline void HashTest(const void* key, int len, uint32_t seed, void* out) {
  ...
  if (len <= 8) {
    uint64_t value;
    switch (len) {
      case 0: value = HashState::ReadSmall(*reinterpret_cast<const std::array<uint8_t, 0> *>(key)); break;
      case 1: value = HashState::ReadSmall(*reinterpret_cast<const std::array<uint8_t, 1> *>(key)); break;
      case 2: value = HashState::ReadSmall(*reinterpret_cast<const std::array<uint8_t, 2> *>(key)); break;
      case 3: value = HashState::ReadSmall(*reinterpret_cast<const std::array<uint8_t, 3> *>(key)); break;
      case 4: value = HashState::ReadSmall(*reinterpret_cast<const std::array<uint8_t, 4> *>(key)); break;
      case 5: value = HashState::ReadSmall(*reinterpret_cast<const std::array<uint8_t, 5> *>(key)); break;
      case 6: value = HashState::ReadSmall(*reinterpret_cast<const std::array<uint8_t, 6> *>(key)); break;
      case 7: value = HashState::ReadSmall(*reinterpret_cast<const std::array<uint8_t, 7> *>(key)); break;
      case 8: value = HashState::ReadSmall(*reinterpret_cast<const std::array<uint8_t, 8> *>(key)); break;
    }
  ...
  *static_cast<uint64_t*>(out) = static_cast<uint64_t>(static_cast<HashCode>(hash));
}
...
inline void AbseilSizedHashTest(const void* key, int len, uint32_t seed, void* out) {
